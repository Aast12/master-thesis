...
\begin{description}
    \item[Transmission Maps] There is a limited amount 
    of real samples taken 
    \item[Diagnostic chest X-ray images] For the development of 
    the framework, the input data consists of images taken from 

...
\fname{main.tex} & & an example of the thesis itself \\
...
Unlike the supervisors and examiner, the macros related to the opponent and oral presentation are in the \fname{main.tex} file.
...
\textbackslash include\{README\_notes/README\_notes\} -- from the \fname{main.tex} file. If you have removed the other README* files from the \dname{README\_notes} directory, you can then remove the \dname{README\_notes} directory.

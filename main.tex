...
as well as introducing me to my first research experience in a welcoming group. I appreciate
his continuous and great mentorship throughout the past few months. I also want to thank
my colleagues at the Hard X-ray lab and Bio-Opto-Nano groups, whom I learned a lot about
...
another hyperparameters considered are a learning rate, and the constraints for the processing parameters. The later
...
shadow artifacts around the segmentation regions as seen in \autoref{fig:shadowArtifacts}. The reason of not needing
...
the original hyperparameters. Specific metrics and examples can be seen in \autoref{app:refinedParamsResults}.
...
that reduce the Mixed loss sufficiently, and also tend to produce images with flat regions as seen in \autoref{fig:flatRegions}.
...
converge at a much higher rate than the transmission map images, although few images stuck in the iteration process
can also be a reason of the high runtime.

\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{figures/weights_boxplot.png}
\caption{Distribution of the processing function parameters from a sample of 200 }
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/initial/pred_ms_ssim_percentiles.png}
\caption{Sample images at percentiles of $\mathcal{L}^{\text{Mix}}$ }
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/initial/histogram_heatmap.png}
\caption{Histograms of recovered transmission maps, sampled 200 images.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/initial/cmp_histogram.png}
\caption{Comparison of histograms between trivial, real, and predicte transmission maps.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/further/pred_ms_ssim_percentiles.png}
\caption{Sample images at percentiles of $\mathcal{L}^{\text{Mix}}$ }
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/further/histogram_heatmap.png}
\caption{Histograms of recovered transmission maps, sampled 200 images.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/further/cmp_histogram.png}
\caption{Comparison of histograms between trivial, real, and predicte transmission maps.}
\end{figure}

...
Digital radiography systems can capture the wide attenuation differences between lungs and mediastinum due to
their wide dynamic range and linear response to th incident radiation. Hoever, it leads to a lack of contrast on
the direct conversion to gray values. At the same time, image sharpness may not be as good as in screen-film
due to the pixel size constraint \cite[p.~148]{Prokop2003}. Screen-film systems, despite having greater spatial
...
characteristics of the radiography systems, but also to amend the intrisic limitations of each detector.
...
\begin{itemize}
    ...
    \item optimizaing spatial resolution of digital chest radiographs,
    \item enhancing structural contrast in the lungs and mediastinum, and
    \item supress image noise \cite[p.~149]{Prokop2003}.
\end{itemize}

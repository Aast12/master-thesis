...
\todo{refine this and goals section, may have too many bullet points}
...
\todo{add reference of attenuation values for body tissues}
...
\todo{add subsection or more details for the x ray image formation process}

...
% Explain constrained nonlinear problems and present the problem in optimization

\subsection{Gradient Descent Methods}

% Explain a general framework of gradient descent methods, and how this approaches nonlinear
% optimization problems

\subsection{Regularization for Ill-Posed Problems}

% Explain the concept of regularization, give extra details about
% nonlinear problems
%
%
...
% Introduce the square penalty regularization and how it helps regularize problems


\subsubsection{Smoothing Regularization}

% explain approaches to achieve 'smooth' solutions when solving optimization problems
%

\subsection{Constrained Optimization}

% explain approaches to achieve solutions that are constrained to certain strict
% constraints such as inequalities

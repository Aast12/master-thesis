...
vary by about 2\% of the dynamic range of an X-ray measurement \todo{maybe the terminology isn't quite right} \cite[p.~34]{epsteinIntroductionMathematicsMedical2008}.
...
\ref{fig:segmentationMasks} shows a sample set of the processed segmentation masks over a CheXpert image using a 0.5 threshold.
